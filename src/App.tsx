...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#110f0e] text-[#eee5dc] flex flex-col justify-between selection:bg-[#c75b24] selection:text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-xs text-[#e8823f] font-mono font-semibold">by YAWASIDE x TRIAGED</span>
      ...
      <main className="max-w-6xl mx-auto w-full px-5 py-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_290px] flex-1">
      ...
      {/* ─── Полезная информация (правая панель) ─── */}
      <aside className="space-y-4">
        <section className="bg-[#181412] border border-[#2b231e] rounded-xl p-5 text-center">
          <div className="text-xs uppercase tracking-wider font-mono text-[#8a7f76]">Почему создан RustFix</div>
          <ArtistPhoto size={96} />
          <div className="mt-3 text-center">
            <div className="font-bold text-white text-base">TRIAGED</div>
            <div className="text-[11px] text-[#7d736b]">создано командой YAWASIDE</div>
          </div>
          <p className="mt-4 text-xs leading-relaxed text-[#9e9185] text-center">
            RustFix создан для исправления проблем, связанных с нестабильными обновлениями Windows. Приложение находит обычные и скрытые обновления CBS и откатывает их в 3 уровня. Если возникнут проблемы с приложением — вы всегда можете обратиться в Telegram.
          </p>

          <div className="mt-5 space-y-2.5">
            <a
              href="https://www.youtube.com/@triaged_rust"
              target="_blank"
              rel="noreferrer noopener"
              className="flex items-center justify-center gap-2 w-full rounded-lg bg-[#2a1310] border border-[#8c2f20] py-2.5 text-xs font-bold text-[#f0dbd4] transition hover:bg-[#3b1b15] hover:border-[#c7452e] hover:text-white"
            >
              <span aria-hidden>▶</span>
              <span>YouTube · triaged_rust</span>
            </a>
            <a
              href={TELEGRAM}
              target="_blank"
              rel="noreferrer noopener"
              className="flex items-center justify-center gap-2 w-full rounded-lg bg-[#163833] border border-[#4fa89a]/60 py-2.5 text-xs font-bold text-[#4fa89a] transition hover:bg-[#1d4b44] hover:text-white"
            >
              <span aria-hidden>✈</span>
              <span>Telegram · TriagedRust</span>
            </a>
          </div>
        </section>
      </aside>
      ...
      <footer className="border-t border-[#211b17] bg-[#14100e] px-5 py-3 text-xs text-[#6e635a]">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <div>RustFix by YAWASIDE x TRIAGED · портативная утилита Windows 11 24H2</div>
          <a
            href={TELEGRAM}
            target="_blank"
            rel="noreferrer noopener"
              ...
              <div className="p-5 overflow-y-auto space-y-5 flex-1 text-xs">
                ...
                {settingsTab === "about" && (
                  <div className="space-y-3.5 text-[#9e9185]">
                    <div>
                      <strong className="text-white text-sm block">RustFix by YAWASIDE x TRIAGED</strong>
